...
<div id = "columns">
    ...
    <figure>
      ...
      <figcaption>
        ...
        <figcaption class = "premiseStatus97PN"></figcaption>
      </figcaption>
      ...
      <figcaption>
        ...
        <figcaption class = "premiseStatus98PN"></figcaption>
      </figcaption>
...
<footer>
  ...
  foreach ($realestates as $realestate) {
    ...
    $premiseStatusText97PN  = "Sprzedane";
    $premiseStatusColor97PN = "red";
    ...
    $premiseStatusText97PN  = "Zarezerwowane";
    $premiseStatusColor97PN = "#e6b800";
  } else if ($idValue === "2313"  && $statusNameValue === "Dostępne") {
    $premiseStatusText97PN  = "Dostępne";
    $premiseStatusColor97PN = "darkgreen";
    ...
    $premiseStatusText98PN  = "Sprzedane";
    $premiseStatusColor98PN = "red";
    ...
    $premiseStatusText98PN  = "Zarezerwowane";
    $premiseStatusColor98PN = "#e6b800";
  } else if ($idValue === "2314"  && $statusNameValue === "Dostępne") {
    $premiseStatusText98PN  = "Dostępne";
    $premiseStatusColor98PN = "darkgreen";
 ...
 premiseStatus01PN.style.color="<?php echo $premiseStatusColor01PN; ?>";
   ...
   let premiseStatus75PN=document.getElementsByClassName("premiseStatus75PN")[0];
  premiseStatus75PN.innerHTML="<?php echo $premiseStatusText75PN; ?>",
  premiseStatus75PN.style.color="<?php echo $premiseStatusColor75PN; ?>";
 



   let premiseStatus77PN=document.getElementsByClassName("premiseStatus77PN")[0];
  premiseStatus77PN.innerHTML="<?php echo $premiseStatusText77PN; ?>",
  premiseStatus77PN.style.color="<?php echo $premiseStatusColor77PN; ?>";

   let premiseStatus78PN=document.getElementsByClassName("premiseStatus78PN")[0];
  premiseStatus78PN.innerHTML="<?php echo $premiseStatusText78PN; ?>",
  premiseStatus78PN.style.color="<?php echo $premiseStatusColor78PN; ?>";

  
  let premiseStatus97PN=document.getElementsByClassName("premiseStatus97PN")[0];
  premiseStatus97PN.innerHTML="<?php echo $premiseStatusText97PN; ?>",
  premiseStatus97PN.style.color="<?php echo $premiseStatusColor97PN; ?>";


  let premiseStatus98PN=document.getElementsByClassName("premiseStatus98PN")[0];
  premiseStatus98PN.innerHTML="<?php echo $premiseStatusText98PN; ?>",
  premiseStatus98PN.style.color="<?php echo $premiseStatusColor98PN; ?>";
