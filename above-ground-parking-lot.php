...
<!-- navbar end -->
  ...
  <img class = "banner" src          = "above-ground-parking-lot.webp">
  <img class = "map" src             = "above-ground-parking-lot-map.webp">
