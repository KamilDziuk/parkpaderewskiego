fetch("popupCookie.html")
.then(resposne => resposne.text())
.then(cookie => 
    
{
let cookie_container =  document.querySelector('#cookie-container');
if(cookie_container) { cookie_container.innerHTML = cookie};
...
if(popupCookie){ popupCookie.classList.add("show2")};
...
if(buttonsCookie){  buttonsCookie.style.width = "93%"};
if(acceptBtn){  acceptBtn.style.left = "50%"};
if(advancedSettings){  advancedSettings.style.left = "50%"};
if(saveBtn){ saveBtn.style.display = "none"};
if(cookieBox){   textCookie.innerHTML = `
...
if(buttonsCookie){ buttonsCookie.style.width = "75%"};
if(acceptBtn){   acceptBtn.style.left = "40%"};
if(advancedSettings){  advancedSettings.style.left = "40%"};
if(buttonsCookie){  buttonsCookie.style.display = "flex"};
if(textCookie){ textCookie.innerHTML = `
...
if(popupCookie){    popupCookie.style.display = "none"};
